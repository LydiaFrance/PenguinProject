...
save_flipper_plot_png(penguins_flippers, "PenguinProject/figures/fig01_report.png", 
                      size = 15, res = 600, scaling = 1)

# Save the plot for a presentation
save_flipper_plot_png(penguins_flippers, "PenguinProject/figures/fig01_powerpoint.png", 
                      size = 15, res = 600, scaling = 1.4)

# Save the plot for a poster
save_flipper_plot_png(penguins_flippers, "PenguinProject/figures/fig01_poster.png", 
                      size = 30, res = 600, scaling = 2.8)

# Save the plot as a vector (no resolution needed)
save_flipper_plot_svg(penguins_flippers, "PenguinProject/figures/fig01_vector.svg", 
                      size = 15, scaling = 1)
